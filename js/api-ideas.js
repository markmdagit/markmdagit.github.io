...
class GeminiImageGenerator {
    ...
    async generate() {
        ...
        // Use placehold.co to simulate the generated image
        // Truncate prompt for URL if too long
        let displayPrompt = prompt.length > 30 ? prompt.substring(0, 30) + '...' : prompt;
        const imageUrl = `https://placehold.co/600x400?text=${encodeURIComponent(displayPrompt)}`;
